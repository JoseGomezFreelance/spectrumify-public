// ================================================================
// Spectrumify — Font bitmap 8x8 (ASCII 32-127)
// ARM64 AArch64 — macOS
// ================================================================
...
_font_8x8:
    ...
    // 83 S
    .byte 0x7C,0xC6,0x60,0x38,0x0C,0xC6,0x7C,0x00
    // 84 T
    .byte 0x7E,0x5A,0x18,0x18,0x18,0x18,0x3C,0x00
    // 85 U
    ...
    // 88 X
    .byte 0xC6,0x6C,0x38,0x38,0x6C,0xC6,0xC6,0x00
    // 89 Y
    ...
    // 106 j
    .byte 0x06,0x00,0x0E,0x06,0x06,0x66,0x66,0x3C
    // 107 k
    .byte 0xE0,0x60,0x66,0x6C,0x78,0x6C,0xE6,0x00
    // 108 l
    .byte 0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00
    // 109 m
    .byte 0x00,0x00,0xEC,0xFE,0xD6,0xC6,0xC6,0x00
    // 110 n
    ...
    // 115 s
    .byte 0x00,0x00,0x7C,0xC0,0x7C,0x06,0xFC,0x00
    // 116 t
    .byte 0x10,0x30,0x7C,0x30,0x30,0x34,0x18,0x00
    // 117 u
    .byte 0x00,0x00,0xCC,0xCC,0xCC,0xCC,0x76,0x00
    // 118 v
    .byte 0x00,0x00,0xC6,0xC6,0x6C,0x38,0x10,0x00
    // 119 w
    .byte 0x00,0x00,0xC6,0xD6,0xFE,0x6C,0x6C,0x00
    // 120 x
    .byte 0x00,0x00,0xC6,0x6C,0x38,0x6C,0xC6,0x00
    // 121 y
    .byte 0x00,0x00,0xC6,0xC6,0xC6,0x7E,0x06,0xFC
    // 122 z
    .byte 0x00,0x00,0xFE,0x8C,0x18,0x32,0xFE,0x00
    // 123 {
